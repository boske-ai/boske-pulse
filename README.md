...
Sibling repo to [`boske`](https://github.com/boske-ai/boske) under `canopystudio/apps/`.
...
- Tailscale-backed private probes (licensing PG on `10.0.0.2:5433`)
...
```bash
cd canopystudio/apps/boske-pulse

...
Standalone repo in the [boske-ai](https://github.com/boske-ai) org; disk home is `src/boske-pulse` (sibling to `boske/`).
...
- Tailscale-backed private probes (Postgres, internal services)

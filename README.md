...
- **Private probes** — Tailscale-backed TCP checks (e.g. licensing PG)
...
Works **without tokens** for public smoke checks only (`boske.dev`, `app.boske.dev`, etc.). Add Coolify + Hetzner tokens in Settings for containers and metrics.

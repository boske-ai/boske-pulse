...
final class CoolifyMapperTests: XCTestCase {
    ...
    func testMergedResourcesIncludesAliasCoolifyServers() {
        ...
        let coolifyServers = [
            CoolifyServer(uuid: "primary", name: "boske-app-01", ip: "203.0.113.10", isReachable: true, isUsable: true),
            CoolifyServer(uuid: "alias", name: "boska-app-01", ip: "203.0.113.10", isReachable: true, isUsable: true)
        ]

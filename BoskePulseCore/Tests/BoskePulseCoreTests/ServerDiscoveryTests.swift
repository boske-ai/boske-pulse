...
final class ServerDiscoveryTests: XCTestCase {
    func testDiscoversCoolifyServersWithOverlays() {
        ...
        let hetzner = [
            HetznerHostInfo(id: 1, name: "boske-app-01", publicIPv4: "203.0.113.10", privateIP: "10.0.0.6", region: "hel1"),
            HetznerHostInfo(id: 2, name: "boske-website", publicIPv4: "203.0.113.20", privateIP: "10.0.0.3", region: "hel1")
        ]
    ...
    func testOverlayDoesNotCrossAssignEndpointsBetweenCoolifyServers() {
        ...
        let hetzner = [
            HetznerHostInfo(id: 1, name: "boske-website", publicIPv4: "203.0.113.20", privateIP: "10.0.0.3", region: "hel1")
        ]
    ...
    func testBoskaHetznerHostMatchesBoskeAppCoolifyServer() {
        ...
        let hetzner = [
            HetznerHostInfo(id: 1, name: "boska-app-01", publicIPv4: "203.0.113.10", privateIP: "10.0.0.6", region: "hel1")
        ]
    ...
    func testOverlayLinksMismatchedCoolifyAndHetznerNamesWhenSameIP() {
        ...
        let coolify = [
            CoolifyServer(uuid: "c1", name: "boske-app-01", ip: "203.0.113.10", isReachable: true, isUsable: true)
        ]
        let hetzner = [
            HetznerHostInfo(id: 1, name: "boska-app-01", publicIPv4: "203.0.113.10", privateIP: "10.0.0.6", region: "fsn1")
        ]
    ...
    func testCanopyKeepsCoolifyIPWhenOverlayAliasIsDifferentHost() {
        ...
        let coolify = [
            CoolifyServer(uuid: "c1", name: "canopy-websites", ip: "203.0.113.30", isReachable: true, isUsable: true)
        ]
        let hetzner = [
            HetznerHostInfo(id: 1, name: "boske-website", publicIPv4: "203.0.113.20", privateIP: "10.0.0.3", region: "hel1")
        ]
